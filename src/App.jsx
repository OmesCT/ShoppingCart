  ...
  const total = subtotal - discount + 100; // Add shipping
    ...
    return (
      <div className="container mx-auto px-4">
        ...
        <p></p>
          <h1 className="text-5xl font-bold text-yellow-600">Fishing Store</h1>
        </header>
    ...
    {products.map(product => (
      <div
        key={product.id}
        className="product-card border border-yellow-300 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
      >
        <img
        ...
        />
        <div className="p-4">
          <h2 className="product-name text-lg font-semibold text-yellow-400">
            {product.name}
          </h2>
          ...
          <button
            className="button bg-yellow-500 text-white py-2 px-4 mt-2 rounded hover:bg-yellow-600 transition"
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <button
                        className="bg-yellow-500 text-white px-4 py-1 rounded hover:bg-red-600 transition"
                  ...
                  <div className="cart-summary p-4 bg-gray-50 border rounded-lg shadow-md mt-4">
                    <input
                      ...
                      className="border p-2 rounded w-full mb-4 text-black placeholder-gray-400 bg-white"
